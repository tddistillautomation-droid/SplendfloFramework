...
export class PricingDetails2 {
  ...
  constructor(page) {
    ...
    this.LineItemType = '(//span[text()="Line Item Type"]//following::span[contains(@class,"_sf-trigger-button-label_ttr")])[5]';
    this.OfferingName = '(//input[@name="Offering Name"])[2]';
    this.Plan = '(//input[@name="plan"])[2]';
    this.PricingModel = '(//span[text()="Pricing Model"]//following::span[contains(@class,"_sf-trigger-button-label_ttr")])[5]';
    this.StartDate = '(//input[@id="startDate"])[3]';
    this.EndDate = '(//input[@id="endDate"])[3]';
    this.Quantity = '(//input[@name="numberOfUnits"])[2]';
    this.UnitOfMeasure = '(//span[text()="Unit of Measure"]//following::span[contains(@class,"_sf-trigger-button-label_ttr")])[5]';
    this.Cost = '(//input[@name="cost"])[3]';
    this.Duration = '(//span[text()="Duration"]//following::span[contains(@class,"_sf-trigger-button-label_ttr")])[5]';
    this.EstimatedUsage = '(//input[@name="estimatedUnitsToBeUsed"])[2]';
    this.Amount = '(//input[@name="amount"])[2]';
    this.LineItemOpen = '(//h3[text()="Line Item:"])[2]';
    this.saveAndContinueBtn = '//p[text()="Save & Continue"]';
    this.confirmationPopup = '//h2[contains(@id,"headlessui-dialog-title")]';

    }


  async openLineItemSection() {
  ...
  async verifyConfirmationPopup(ExpectedPopup) {
    await this.keywords.waitUntilVisible(
      this.confirmationPopup,
      'Confirmation Popup'
    );

    const ActualPopup = await this.keywords.getText(  
      this.confirmationPopup,
      'Confirmation Popup'
    );
